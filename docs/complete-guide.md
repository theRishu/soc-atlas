...
<div class="pdf-guide-actions" markdown>
[Download This Guide as PDF](complete-guide.md?download=1){ .md-button .md-button--primary }
[Open Reading View](complete-guide.md){ .md-button }
</div>

<div class="pdf-guide-note" markdown>
**How to download the full guide**

Use the button above to open your browser's print dialog, then choose **Save as PDF** to download the entire SOCAtlas guide as one document.
</div>
